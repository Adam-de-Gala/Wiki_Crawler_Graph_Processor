...
public class Wiki_Crawler {
    ...
    Wiki_Crawler(String seedUrl, int max, String fileName) throws Exception {
    ...
    {
        Wiki_Crawler crawler = new Wiki_Crawler("/wiki/Computer_Science", 500, "WikiCS.txt");
        crawler.crawl();
